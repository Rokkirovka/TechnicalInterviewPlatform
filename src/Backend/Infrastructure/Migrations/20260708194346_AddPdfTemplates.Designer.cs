...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260708194346_AddPdfTemplates")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.PdfTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.PdfTemplateField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PdfTemplateId", "Name")
                        .IsUnique();

                    b.ToTable("PdfTemplateFields");
                });

            modelBuilder.Entity("Domain.Entities.PdfTemplateFieldMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("CandidateFieldKey")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("PdfTemplateId", "PdfFieldName")
                        .IsUnique();

                    b.ToTable("PdfTemplateFieldMappings");
                });
            ...
            modelBuilder.Entity("Domain.Entities.PdfTemplateField", b =>
                {
                    b.HasOne("Domain.Entities.PdfTemplate", "PdfTemplate")
                        .WithMany("Fields")
